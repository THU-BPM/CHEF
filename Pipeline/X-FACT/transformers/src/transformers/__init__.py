...
if is_sklearn_available():
    from .data import glue_compute_metrics, xnli_compute_metrics, xfact_compute_metrics
...
if is_torch_available():
    ...
    # New Imports
    from .multitask_utils import MultiTaskBertForSequenceClassification
    from .multitask_utils import MultiTaskBertForEvidenceBasedClassification
    from .multitask_utils import MultiTaskBertForEvidenceBasedClassificationMeanAggregator
